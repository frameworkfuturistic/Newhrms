    ...
    <div class="account-content">
        <div class="container">
            ...
            <div class="account-logo">
                <a href="index.html"><img src="{{ URL::to('assets/img/logo.png') }}" alt=""></a>
            </div>
            <!-- /Account Logo -->
            <div class="account-box">
                <div class="account-wrapper">
                    ...
                    <form method="POST" action="{{ route('registerData') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Photo</label>
                            <input type="file" class="form-control @error('avatar') is-invalid @enderror" name="avatar" value="{{ old('avatar') }}" placeholder="Enter Your Photo">
                            @error('avatar')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
